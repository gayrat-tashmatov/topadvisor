    ...
    <section className="relative py-24 md:py-32">
      <div className="container-wide section-padding">
        <div className="relative glass-card p-10 md:p-14 overflow-hidden">
          {/* Background accent */}
          <div className="absolute inset-0 bg-gradient-to-br from-gold-400/[0.03] via-transparent to-accent-blue/[0.02]" />

          <div className="relative z-10 max-w-2xl mx-auto text-center">
            {/* Icon */}
            <div className="w-14 h-14 rounded-2xl bg-gold-400/10 flex items-center justify-center mx-auto mb-6">
            ...
            >
              <input
                ...
                className="flex-1 bg-white/[0.04] border border-white/[0.08] rounded-xl px-5 py-3.5 text-sm text-white placeholder:text-white/25 focus:outline-none focus:border-gold-400/40 transition-colors"
              />
              <button
                type="submit"
            ...
            <a
              ...
              className="inline-flex items-center gap-2 text-xs text-white/30 hover:text-gold-400/60 transition-colors"
            >
              <Send size={14} />
              {t('telegram')}
            </a>
